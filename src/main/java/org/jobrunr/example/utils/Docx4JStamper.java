package org.jobrunr.example.utils;
 ...
 * @author Ronald Dehuysser (replace javax with jakarta)
 */
public class Docx4JStamper {

    private static final Logger LOGGER = LoggerFactory.getLogger(Docx4JStamper.class);
